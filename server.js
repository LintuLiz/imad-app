...
var articles= {
'article-one': {
                 title:'Article One|Lintu Liz Thomas',
                 heading:'Article One',
                  date:'Sep 5,2016',
                content:`
                <p>
...
'article-two': {
         title:'Article Two|Lintu Liz Thomas',
         heading:'Article Two',
         date:'Sep 10,2016',
         content:`
                <p>
...
'article-three': {
         title:'Article Three|Lintu Liz Thomas',
...
app.post('/create-user',function(req,res){
   ...
   pool.query('INSERT INTO "user" (username,password) VALUES($1,$2)',[username,result],function(err,result){
   if(err){
